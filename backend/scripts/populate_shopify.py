...
Uses the Admin REST API (simpler + more stable than GraphQL for product creation).
Creates ~90 products across 5 categories with realistic prices, tags, descriptions,
and metafields (rating, review_count, review_highlight).
"""
...
_STORE_URL   = _normalize_shop_domain(_first_env("SHOPIFY_STORE_URL", "SHOPIFY_SHOP_DOMAIN"))
_ADMIN_TOKEN = _first_env("SHOPIFY_ADMIN_TOKEN", "SHOPIFY_ADMIN_ACCESS_TOKEN")
_API_VERSION = "2024-01"
_BASE        = f"https://{_STORE_URL}/admin/api/{_API_VERSION}"
_HEADERS     = {
...
PRODUCTS = [
...

    {
        ...
        "body_html": "The Nike Air Zoom Pegasus 40 is the go-to daily trainer for road runners. Zoom Air cushioning delivers a responsive, springy ride while the breathable mesh upper keeps your foot cool on long runs. Ideal for everyday training and race days.",
        "price": "8995.00",
    ...
    },
    {
        ...
        "body_html": "Designed to reduce injury risk for road runners. Wide, rocker-shaped sole helps guide your foot through each stride. Nike React foam provides maximum cushioning — ideal for runners with flat feet or overpronation.",
        "price": "10995.00",
    ...
    },
    {
        ...
        "body_html": "Boost midsole technology stores and returns energy with every stride. Primeknit+ upper wraps your foot like a second skin. Premium road running shoe for those who want speed without sacrificing comfort.",
        "price": "12999.00",
    ...
    },
    {
        ...
        "body_html": "Lightweight road running shoe with targeted banding for midfoot support. Boost midsole for responsive cushioning. Great choice for tempo runs and long-distance training.",
        "price": "8499.00",
    ...
    },
    {
        ...
        "body_html": "Ultra-lightweight road runner with 5GEN cushioning. Mesh upper provides ventilation. Excellent value for beginner and intermediate runners training on roads. Wide toe-box suits flat feet.",
        "price": "4499.00",
    ...
    },
    {
        ...
        "body_html": "Responsive 5GEN cushioning for road running. Flexible, lightweight upper with a seamless design. Ideal for women looking for an affordable daily trainer.",
        "price": "3799.00",
    ...
    },
    {
        ...
        "body_html": "Maximum cushioning for long-distance road running. Fresh Foam X midsole delivers plush underfoot feel. Hypoknit upper adapts to foot movement. Best-in-class comfort for half marathons and beyond.",
        "price": "14999.00",
    ...
    },
    {
        ...
        "body_html": "Speed-oriented FuelCell foam for fast road running. Lightweight and responsive — perfect for tempo runs and 5K/10K races. For neutral runners looking for a performance edge.",
        "price": "9999.00",
    ...
    },
    {
        ...
        "body_html": "NITRO foam midsole offers an excellent weight-to-cushioning ratio. Engineered mesh upper for breathability. Great everyday road shoe at a mid-range price.",
        "price": "6999.00",
    ...
    },
    {
        ...
        "vendor": "Brooks",
        "product_type": "Running Shoes",
        "tags": "running-shoes,road-running,brooks,neutral,cushioning,versatile,flat-feet-support",
        "body_html": "Iconic neutral daily trainer from Brooks. DNA LOFT v3 foam for soft cushioning. Accommodating fit works for a wide range of foot shapes including flat feet.",
        "price": "11999.00",
    ...
    },
    {
        ...
        "body_html": "Floatride Energy foam delivers a lightweight yet cushioned ride for road runners. Durable rubber outsole for all-weather traction. Ideal for daily training runs.",
        "price": "5999.00",
    ...
    },
    {
        ...
        "body_html": "Built for trail running on technical terrain. Continental rubber outsole for multi-surface grip. Waterproof GORE-TEX lining keeps feet dry in wet conditions.",
        "price": "9499.00",
    ...
    },
    {
        ...
        "body_html": "Rugged trail running shoe with multi-directional traction lugs for off-road grip. Rock plate protects against sharp surfaces. Durable for technical hill runs.",
        "price": "7499.00",
    ...
    },
    {
        ...
        "body_html": "Ultra-lightweight training shoe with Hyper Burst cushioning. Low-profile design for gym workouts, HIIT, and strength training. Flexible sole for multi-directional movement.",
        "price": "3299.00",
    ...
    },
    {
        ...
        "body_html": "Nike's premier cross-training shoe. Flat, stable heel for lifting; flexible forefoot for sprints and jumps. The go-to for gym, CrossFit, and functional fitness training.",
        "price": "9995.00",
...

    {
        ...
        "body_html": "High-strength niacinamide serum reduces the appearance of blemishes, pores, and excess oil. Zinc balances sebum production. Ideal for oily and acne-prone skin types.",
        "price": "690.00",
    ...
    },
    {
        ...
        "body_html": "BHA serum that penetrates into pores to clear blackheads and prevent acne. Lightweight oil-free formula ideal for oily and combination skin.",
        "price": "549.00",
    ...
    },
    {
        ...
        "body_html": "Broad-spectrum SPF 50 PA++++ sunscreen with no white cast. Water-based formula ideal for oily skin in Indian summers. Non-comedogenic and dermatologically tested.",
        "price": "399.00",
    ...
    },
    {
        ...
        "body_html": "Oil-free gel moisturiser for oily and combination skin. Hydrates without clogging pores. 72-hour moisture lock with Hyaluronic Acid and Niacinamide.",
        "price": "699.00",
    ...
    },
    {
        ...
        "body_html": "Vitamin E and plant extracts deeply nourish dry skin without greasiness. Fast-absorbing formula that leaves skin soft and radiant.",
        "price": "399.00",
    ...
    },
    {
        ...
        "body_html": "Rich, non-greasy moisturiser for dry and sensitive skin. Fragrance-free, non-comedogenic formula. Dermatologist recommended for eczema-prone and very dry skin.",
        "price": "849.00",
    ...
    },
    {
        ...
        "body_html": "Multi-weight hyaluronic acid for deep and surface hydration. Vitamin B5 supports skin healing. Ideal for dry and dehydrated skin — gives an instant plumping effect.",
        "price": "750.00",
    ...
    },
    {
        ...
        "body_html": "Ethyl Ascorbic Acid (stable Vitamin C) at 10% concentration for visible brightening. Reduces dark spots, hyperpigmentation, and dullness. Suitable for all skin types.",
        "price": "599.00",
    ...
    },
    {
        ...
        "body_html": "Turmeric and saffron face wash that brightens skin while removing excess oil and impurities. No harmful chemicals. Suitable for oily and normal skin types.",
        "price": "249.00",
    ...
    },
    {
        ...
        "body_html": "Iconic French micellar water that gently removes makeup and cleanses sensitive skin without rinsing. Ophthalmologist tested. No drying effect.",
        "price": "1099.00",
    ...
    },
    {
        ...
        "body_html": "Clinically proven hyaluronic acid gel moisturiser. Instantly quenches dry skin and keeps it hydrated for 48 hours. Lightweight, oil-free formula suitable for combination skin.",
        "price": "999.00",
    ...
    },
    {
        ...
        "body_html": "Premium daily moisturiser with SPF 30 protection. Squalane and glacial glycoprotein provide intense long-lasting hydration. Suitable for dry to normal skin.",
        "price": "3200.00",
    ...
    },
    {
        ...
        "body_html": "Jeju green tea seed extract serum that provides moisture and antioxidant protection. Lightweight formula that layers well with other serums. Suitable for all skin types.",
        "price": "1499.00",
    ...
    },
    {
        ...
        "body_html": "Physical exfoliator with green tea extract and botanical beads. Unclogs pores and removes dead skin cells without over-stripping. Vegan and toxin-free.",
        "price": "345.00",
...

    {
        ...
        "body_html": "Galaxy AI features, ProVisual Engine for stunning 50MP photography, and 7 years of OS updates. Snapdragon 8 Gen 3 chipset. Bright 6.2-inch Dynamic AMOLED 2X display with 120Hz refresh rate.",
        "price": "74999.00",
    ...
    },
    {
        ...
        "body_html": "Snapdragon 8 Gen 3, Hasselblad-tuned 50MP triple camera, 100W SUPERVOOC fast charging. 6.82-inch AMOLED display at 120Hz with 4500 nits peak brightness.",
        "price": "64999.00",
    ...
    },
    {
        ...
        "body_html": "Leica co-engineered triple camera with 50MP main sensor. Snapdragon 8 Gen 3 flagship chipset. 6.36-inch AMOLED with 120Hz. 90W HyperCharge for full battery in 31 minutes.",
        "price": "59999.00",
    ...
    },
    {
        ...
        "body_html": "Snapdragon 8s Gen 3 processor for flagship gaming performance at mid-range price. 120Hz SuperAMOLED display, 5000mAh battery with 120W fast charging.",
        "price": "39999.00",
    ...
    },
    {
        ...
        "body_html": "Samsung's best mid-range with IP67 water resistance, 50MP OIS camera, and 6.6-inch Super AMOLED. 4 years of OS updates. Gorilla Glass Victus+.",
        "price": "38999.00",
    ...
    },
    {
        ...
        "body_html": "200MP main camera at mid-range pricing. Dimensity 7200-Ultra chipset, 6.67-inch AMOLED at 120Hz, 5000mAh battery with 120W charging. IP68 water resistance.",
        "price": "29999.00",
    ...
    },
    {
        ...
        "body_html": "Snapdragon 7s Gen 2, 6.7-inch AMOLED 120Hz display, 5000mAh battery with 100W SUPERVOOC charging. OxygenOS 14 for clean software experience.",
        "price": "24999.00",
    ...
    },
    {
        ...
        "body_html": "Exynos 1380 chipset with 50MP OIS camera. 6.6-inch Super AMOLED at 120Hz. IP67, Gorilla Glass Victus+. 5000mAh battery. 4 years OS + 5 years security updates.",
        "price": "26999.00",
    ...
    },
    {
        ...
        "body_html": "Dimensity 7050 chipset with 50MP Sony IMX890 camera. 6.7-inch AMOLED 120Hz display. 5000mAh battery with 67W fast charging.",
        "price": "17999.00",
    ...
    },
    {
        ...
        "body_html": "Google Tensor G3 chip with Google AI features. Best-in-class computational photography. Guaranteed 7 years of Android updates. 6.1-inch OLED display.",
        "price": "52999.00",
...

    {
        ...
        "body_html": "Intel Core i7-13650HX + NVIDIA RTX 4070 8GB GPU. 16-inch QHD 165Hz IPS display. 16GB DDR5 RAM, 512GB NVMe SSD. MUX Switch, ROG Boost for peak gaming performance.",
        "price": "124999.00",
    ...
    },
    {
        ...
        "body_html": "Intel Core i5-13420H + NVIDIA RTX 4060 laptop GPU. 15.6-inch FHD 144Hz display. 16GB DDR5, 512GB SSD. Excellent budget gaming laptop for 1080p gaming at high settings.",
        "price": "74999.00",
    ...
    },
    {
        ...
        "body_html": "AMD Ryzen 7 7745HX + NVIDIA RTX 4050 6GB. 16.1-inch FHD 144Hz display. 16GB DDR5 RAM, 512GB PCIe SSD. Great gaming performance for mid-range budget.",
        "price": "64999.00",
    ...
    },
    {
        ...
        "body_html": "Intel Core i7-13700H + Intel Arc A530M GPU. 16-inch 3K IPS display. 16GB DDR5, 512GB SSD. Excellent for students, creators, and professionals who need a large display.",
        "price": "69999.00",
    ...
    },
    {
        ...
        "body_html": "AMD Ryzen 7 7730U + 2-in-1 form factor. 14-inch OLED touchscreen display. 16GB RAM, 512GB SSD. Lightweight at 1.46kg with up to 17 hours battery life.",
        "price": "79999.00",
    ...
    },
    {
        ...
        "body_html": "AMD Ryzen 7 7730U processor. 15.6-inch FHD IPS display. 16GB RAM, 512GB SSD. Lightweight design with up to 12 hours battery life. Excellent student and everyday work laptop.",
        "price": "54999.00",
    ...
    },
    {
        ...
        "body_html": "AMD Ryzen 9 7940HS + Radeon 780M integrated graphics. 16-inch WUXGA IPS display. 16GB DDR5, 512GB SSD. Powerful daily laptop for students and light creative work.",
        "price": "61999.00",
    ...
    },
    {
        ...
        "body_html": "Intel Core Ultra 5 125H. 14-inch FHD+ IPS display. 16GB LPDDR5, 512GB NVMe SSD. Ultra-thin design at 1.4kg. 12-hour battery life. Ideal for business professionals.",
        "price": "58999.00",
...

    {
        ...
        "body_html": "Industry-leading noise cancellation with dual processor. 30-hour battery life, 3-min quick charge for 3 hours. Multipoint connection for 2 devices. Best ANC headphones available.",
        "price": "24990.00",
    ...
    },
    {
        ...
        "product_type": "Headphones",
        "tags": "headphones,sony,wireless,noise-cancelling,anc,premium,music,travel",
        "body_html": "Previous gen flagship with best-in-class noise cancellation. 30-hour battery, multipoint pairing, Speak-to-Chat. Often available at a significant discount over XM5.",
        "price": "19990.00",
    ...
    },
    {
        ...
        "body_html": "Adaptive noise cancelling with Smart Ambient. 65-hour battery life. JBL Pure Bass Sound for powerful low-end. VoiceAware for natural conversation without removing headphones.",
        "price": "9999.00",
    ...
    },
    {
        ...
        "body_html": "TriPort acoustic architecture with Bose proprietary ANC. 24-hour battery, ultra-lightweight design. Quiet and Aware Modes. Excellent for frequent flyers and office use.",
        "price": "29900.00",
    ...
    },
    {
        ...
        "body_html": "50mm custom drivers with boAt Signature Sound. 20-hour playback, fast charge. Foldable design for portability. Budget wireless headphones with punchy bass for casual listeners.",
        "price": "1299.00",
    ...
    },
    {
        ...
        "body_html": "Active noise cancellation with Sennheiser's signature balanced sound profile. 30-hour battery. Foldable design. Excellent option for music purists who prefer accurate sound over boosted bass.",
        "price": "7999.00",
    ...
    },
    {
        ...
        "body_html": "Adjustable sensory bass with haptic feedback you can feel. Personal Sound with Audiodo. 40-hour battery. Rapid Charge. Best for bass-lovers and an immersive listening experience.",
        "price": "8499.00",
    ...
    },
    {
        ...
        "body_html": "Co-engineered with Dynaudio. Up to 48dB ANC, 11mm + 6mm dual drivers. Spatial audio. 39-hour total battery. Best ANC earbuds under 10K.",
        "price": "9499.00",
    ...
    },
    {
        ...
        "body_html": "World's best noise cancelling earbuds. V2 processor and integrated processor Q1. 8-hour battery + 24 hours with case. Crystal-clear call quality with 6 beamforming mics.",
        "price": "19990.00",
    ...
    },
    {
        ...
        "body_html": "Adaptive noise cancellation with JBL Pure Bass. 44-hour battery. Foldable, lightweight design. Multi-point Bluetooth connection. Best budget ANC headphones.",
        "price": "4999.00",
...
async def create_product(client: httpx.AsyncClient, product: dict) -> int | None:
    """Create product via REST API. Returns numeric product ID or None on error."""
    payload = {
        "product": {
            "title":        product["title"],
...
async def add_metafield(client: httpx.AsyncClient, product_id: int, namespace: str, key: str, value: str, type_: str) -> None:
    """Add a single metafield to a product."""
    resp = await client.post(
        f"{_BASE}/products/{product_id}/metafields.json",
        headers=_HEADERS,
        json={"metafield": {"namespace": namespace, "key": key, "value": value, "type": type_}},
    )
    if resp.status_code not in (200, 201):
        print(f"    ⚠  metafield {key} failed: {resp.status_code}")


async def set_metafields(client: httpx.AsyncClient, product_id: int, product: dict) -> None:
    """Set rating, review_count, review_highlight metafields."""
    if product.get("rating"):
        await add_metafield(client, product_id, "shopsense", "rating", str(product["rating"]), "number_decimal")
    if product.get("review_count"):
        await add_metafield(client, product_id, "shopsense", "review_count", str(product["review_count"]), "number_integer")
    if product.get("review_highlight"):
        await add_metafield(client, product_id, "shopsense", "review_highlight", product["review_highlight"], "single_line_text_field")
...
async def main():
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        for i, product in enumerate(PRODUCTS, 1):
            print(f"[{i:02d}/{len(PRODUCTS)}] {product['title']} — ₹{float(product['price']):,.0f}")

            pid = await create_product(client, product)
            if pid:
                await set_metafields(client, pid, product)
                print(f"  ✓  created — id:{pid}")
                created += 1
            else:
                failed += 1

            # Shopify REST: ~2 req/s leaky bucket; be conservative
            await asyncio.sleep(0.6)

    print(f"\n{'─'*50}")
    print(f"✅  Created: {created}   ✗ Failed: {failed}")
    print(f"\nNext: go to {_STORE_URL}/admin/products to verify, then add SHOPIFY_ADMIN_TOKEN to Railway env vars.")
